...
Read `REPO_SETUP_CHECKLIST.md` and execute each item in order, checking them off as you go. The checklist is the single source of truth for all initialization steps.
